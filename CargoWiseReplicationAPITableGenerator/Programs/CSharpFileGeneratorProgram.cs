...
{
	public static class CSharpFileGeneratorProgram
	{
		public static async Task Run(CSharpFileGeneratorOptions opts)
		{
			...
			var path = Path.Combine(opts.OutputPath, parsed.Params.TableName + ".cs");
